...
| **[AHSEA](https://github.com/Rancidgift57/Autonomous-Hierarchical-Software-Engineering-Agents)** | AHSEA is an autonomous hierarchical multi-agent software engineering system that transforms project ideas into working software. It coordinates specialized AI agents for requirements, architecture, task planning, coding, debugging, testing, code review, integration, and deployment.| Python, Langgarph, Orchestration, AgenticAI |
